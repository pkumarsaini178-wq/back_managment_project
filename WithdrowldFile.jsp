...
<div class="container">
    <form action="withdrowle" method="post">
        <h2>Withdrowle Money</h2>
        ...
        <input type="number" id="deposit_amount" name="withdrowle_amount" placeholder="Enter Deposit Amount" required>

        <button type="submit">Submit withdrworle</button>
    </form>
